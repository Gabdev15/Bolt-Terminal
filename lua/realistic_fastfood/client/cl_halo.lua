...
function RFS.Halo.Add( ents, color, mode )
...
function RFS.Halo.RenderedEntity()
...
function RFS.Halo.SetRenderType( render_type )
...
function RFS.Halo.GetRenderType()
	
	return RenderType
	
end

function RFS.Halo.SetDoubleThickness( thickness )
...
function RFS.Halo.IsDoubleThickness()
...
local function RenderOutlines()
	...
	hook.Run( "SetupOutlines", RFS.Halo.Add )
...
hook.Add( "PreDrawViewModels", "RFS:Halo:RenderOutlines", function()
...
hook.Add( "PreDrawEffects", "RFS:Halo:RenderOutlines", function()
...
hook.Add( "PostDrawEffects", "RFS:Halo:RenderOutlines", function()
