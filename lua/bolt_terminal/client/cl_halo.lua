...
function BT.Halo.Add( ents, color, mode )
...
function BT.Halo.RenderedEntity()
...
function BT.Halo.SetRenderType( render_type )
...
function BT.Halo.GetRenderType()
	
	return RenderType
	
end

function BT.Halo.SetDoubleThickness( thickness )
...
function BT.Halo.IsDoubleThickness()
...
local function RenderOutlines()
	...
	hook.Run( "SetupOutlines", BT.Halo.Add )
...
hook.Add( "PreDrawViewModels", "BT:Halo:RenderOutlines", function()
...
hook.Add( "PreDrawEffects", "BT:Halo:RenderOutlines", function()
...
hook.Add( "PostDrawEffects", "BT:Halo:RenderOutlines", function()
